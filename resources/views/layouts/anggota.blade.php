...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    /* ====================================================
       DESKTOP (≥ 1200px) — sidebar penuh, tanpa hamburger
    ==================================================== */
    ...
    @media (min-width: 768px) and (max-width: 1199.98px) {
        ...
        .sidebar.toggled { width: var(--sidebar-w) !important; }
        .sidebar.toggled .sidebar-brand-text,
        .sidebar.toggled .nav-item .nav-link span { display: inline-block !important; }
        .sidebar.toggled .sidebar-heading         { display: block !important; }
        .sidebar.toggled .nav-item .nav-link {
    ...
    @media (max-width: 767.98px) {
        ...
        /* Active item background hanya selebar konten nav-link */
...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item {{ Request::routeIs('anggota.riwayatpinjam') ? 'active' : '' }}">
         ...
         <li class="nav-item {{ Request::routeIs('anggota.petunjuk') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('anggota.petunjuk') }}" title="Petunjuk Penggunaan">
                <i class="fas fa-question-circle"></i><span>Petunjuk Penggunaan</span>
            </a>
        </li>
