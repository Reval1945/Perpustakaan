<table>
    ...
    <tr>
        <td colspan="5" style="border-bottom: 3px double #000000; height: 5px;"></td>
    </tr>

    <tr><td colspan="5" style="height: 15px;"></td></tr>

    <tr>
        <td colspan="5" style="text-align: center; font-size: 12pt; font-weight: bold; height: 30px; vertical-align: middle;">
    ...
    <thead>
        <tr style="background-color: #3498DB; color: #FFFFFF; font-weight: bold; text-align: center;">
            ...
            <th style="border: 1px solid #000000; width: 300px;">JUDUL BUKU</th>
    ...
    <tbody>
        ...
        @forelse($transaksi as $trx)
            @foreach($trx->details as $detail)
                <tr>
                    ...
                    <td style="border: 1px solid #000000; text-align: center; vertical-align: middle;">{{ $trx->tanggal_pinjam }}</td>
                    <td style="border: 1px solid #000000; text-align: center; vertical-align: middle;">{{ $detail->tanggal_jatuh_tempo }}</td>
        ...
        @empty
            <tr>
                <td colspan="5" style="border: 1px solid #000000; text-align: center;">Data tidak ditemukan</td>
            </tr>
        @endforelse
    </tbody>
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="5" style="text-align: right; font-size: 8pt; font-style: italic;">
